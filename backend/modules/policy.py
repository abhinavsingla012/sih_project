...
def authorize(user, action, app=None):
    permissions = {'create': {'citizen'}, 'operate': {'operator'}, 'inspect': {'operator', 'auditor', 'official'}, 'read': {'citizen', 'operator', 'auditor', 'official', 'service'}, 'data_access': {'service'}, 'revoke': {'citizen'}}
