...
export const Brand = () => <div className="brand" data-testid="brand"><span className="brand-mark"><Network size={24}/></span><span>Samanvay<span className="brand-caption">INTEROPERABILITY FABRIC</span></span></div>;
